...
import it.codingjam.testingrxjava.TestSchedulerRule1;
...
public class UserServiceTest_6 {
    ...
    @Rule public TestSchedulerRule1 testSchedulerRule = new TestSchedulerRule1();

    @Mock StackOverflowService stackOverflowService;

    @InjectMocks UserService2 userService;
